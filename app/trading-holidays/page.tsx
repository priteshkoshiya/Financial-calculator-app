...
const indianHolidays2026 = [
  { date: 'Thu, Jan 15, 2026', occasion: 'Municipal Elections (Maharashtra)', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Mon, Jan 26, 2026', occasion: 'Republic Day', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Tue, Mar 03, 2026', occasion: 'Holi', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Thu, Mar 26, 2026', occasion: 'Shri Ram Navami', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Tue, Mar 31, 2026', occasion: 'Shri Mahavir Jayanti', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Fri, Apr 03, 2026', occasion: 'Good Friday', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Tue, Apr 14, 2026', occasion: 'Dr. Baba Saheb Ambedkar Jayanti', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Fri, May 01, 2026', occasion: 'Maharashtra Day', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Thu, May 28, 2026', occasion: 'Bakri Id (Id-ul-Zuha)', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Fri, Jun 26, 2026', occasion: 'Muharram', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Mon, Sep 14, 2026', occasion: 'Ganesh Chaturthi', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Fri, Oct 02, 2026', occasion: 'Mahatma Gandhi Jayanti', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Tue, Oct 20, 2026', occasion: 'Dussehra', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Tue, Nov 10, 2026', occasion: 'Diwali-Balipratipada', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Tue, Nov 24, 2026', occasion: 'Gurunanak Jayanti', market: 'NSE, BSE', status: 'Closed' },
  { date: 'Fri, Dec 25, 2026', occasion: 'Christmas', market: 'NSE, BSE', status: 'Closed' },
];

const usNasdaqHolidays2026 = [
  { date: 'Thu, Jan 01, 2026', occasion: 'New Year\'s Day', status: 'Closed', market: 'Nasdaq, NYSE' },
  { date: 'Mon, Jan 19, 2026', occasion: 'Martin Luther King, Jr. Day', status: 'Closed', market: 'Nasdaq, NYSE' },
  { date: 'Mon, Feb 16, 2026', occasion: 'Washington\'s Birthday (Presidents Day)', status: 'Closed', market: 'Nasdaq, NYSE' },
  { date: 'Fri, Apr 03, 2026', occasion: 'Good Friday', status: 'Closed', market: 'Nasdaq, NYSE' },
  { date: 'Mon, May 25, 2026', occasion: 'Memorial Day', status: 'Closed', market: 'Nasdaq, NYSE' },
  { date: 'Fri, Jun 19, 2026', occasion: 'Juneteenth Natl. Independence Day', status: 'Closed', market: 'Nasdaq, NYSE' },
  { date: 'Fri, Jul 03, 2026', occasion: 'Independence Day (Observed)', status: 'Closed', market: 'Nasdaq, NYSE' },
  { date: 'Mon, Sep 07, 2026', occasion: 'Labor Day', status: 'Closed', market: 'Nasdaq, NYSE' },
  { date: 'Thu, Nov 26, 2026', occasion: 'Thanksgiving Day', status: 'Closed', market: 'Nasdaq, NYSE' },
  { date: 'Fri, Nov 27, 2026', occasion: 'Day after Thanksgiving', status: 'Early Close (1:00 PM)', market: 'Nasdaq, NYSE' },
  { date: 'Thu, Dec 24, 2026', occasion: 'Christmas Eve', status: 'Early Close (1:00 PM)', market: 'Nasdaq, NYSE' },
  { date: 'Fri, Dec 25, 2026', occasion: 'Christmas Day', status: 'Closed', market: 'Nasdaq, NYSE' },
];
                      ...
                      >
                        ...
                        <td className="py-4 px-6">
                           {isPassed ? (
                             ...
                             <span className="text-xs font-bold text-primary">{holiday.status}</span>
                           )}
                        </td>
                      </tr>
                    );
